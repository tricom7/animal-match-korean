...
//    buttonDictionary = [NSMutableDictionary dictionary];
...
//            NSLog(@"animalName(KEY)=%@",animalName);
        }
    } 
}
...
//        NSLog(@"Add to selectAnimals : %d",animal_num);
    }
    
//    NSLog(@"selectedAnimals count = %d",[selectedAnimals count]);
    
    for (NSNumber *n in selectedAnimals) {
        [selectedArray1 addObject:n];
//        NSLog(@"Add to selectedArray1 : %d",[n intValue]);
    }
...
//        NSLog(@"Add to selectedArray2 : %d",[[selectedArray1 objectAtIndex:animal_num] intValue]);
    }
    
//    NSLog(@"selectedArray1 count = %d, selectedArray1 count = %d",[selectedArray1 count], [selectedArray2 count]);
...
//                NSLog(@"animalName2 = %@", animalName2);
            ...
            if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone) {
                ...
                //NSLog(@"animalName2 = %@, animalName2.length = %d",animalName2, animalName2.length);
...
- (void)buttonClicked:(UIButton*)button
{
    ...
    if (isSecondButton) {
        ...
        if ([preTitle isEqualToString:button.titleLabel.text]) {
            //NSLog(@"Matched !!! %@", button.titleLabel.text);
...
//            NSLog(@"button.titleLabel.text(KEY)=%@",button.titleLabel.text);
            ...
            //NSLog(@"[remainAnimals count]=%d",[remainAnimals count]);
